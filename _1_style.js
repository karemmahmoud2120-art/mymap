...
var style__1 = function(feature, resolution){
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("population");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    if (value >= 500000.000000 && value <= 1000000000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10000000.000000 && value <= 30000000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30000000.000000 && value <= 50000000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 50000000.000000 && value <= 70000000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 70000000.000000 && value <= 90000000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9000000.000000 && value <= 110000000.000000) {
            style = [ new ol.style.Style({
